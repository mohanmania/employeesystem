    ...
    <div className="flex flex-col items-center h-screen justify-center bg-gradient-to-b from-teal-300 from-50% to-gray-100 to-50% space-y-6">
      ...
      <div className="border shadow p-6 w-80 bg-white">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <button type="submit" className="w-full bg-red-300 text-white py-2">Register</button>
          </div>
          <p>Have already Acoount <Link to="/login"><span className="text-purple-500 underline">LOGIN</span></Link></p>
        </form>
      </div>
    </div>
  );
